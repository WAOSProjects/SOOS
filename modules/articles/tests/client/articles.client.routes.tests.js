(function () {
  ...
  describe('Articles Route Tests', function () {
    ...
    beforeEach(inject(function ($rootScope, _$httpBackend_, _ArticlesService_, _Authentication_) {
    ...
    describe('Route Config', function () {
      describe('Main Route', function () {
        ...
        it('Should have the correct URL', function () {
          expect(mainstate.url).toEqual('/home/articles');
        });
      ...
      describe('Create Route', function () {
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(createstate)).toEqual('/home/articles/create');
        }));
      ...
      describe('Handle Trailing Slash', function () {
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope) {
          ...
          $rootScope.$digest();
          expect($location.path()).toBe('/home/articles');
