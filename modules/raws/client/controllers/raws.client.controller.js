...
(function() {
  ...
  RawsController.$inject = ['$scope', '$state', '$http', '$timeout', '$sce', 'Authentication', 'dataService', '_', '$mdDialog', '$mdMedia'];

  function RawsController($scope, $state, $http, $timeout, $sce, Authentication, dataService, _, $mdDialog, $mdMedia) {
    ...
    $scope.samples = [{
      ...
      },
      {
        title: 'Countries GDP',
        type: 'Other',
        url: '../assets/data/countriesGDP.csv'
      },
      {
        title: 'Cars',
        type: 'Multivariate',
      ...
      },
      {
        ...
        type: 'Time Series',
        url: '../assets/data/music.csv'
      },
      {
        title: 'Lineup',
        type: 'Time chunks',
        url: '../assets/data/lineup.tsv'
      },
      {
        title: 'Orchestras',
        type: 'Hierarchies (weighted)',
        url: '../assets/data/orchestra.csv'
      },
      {
        title: 'Animal kingdom',
        type: 'Hierarchies',
        url: '../assets/data/animals.tsv'
      },
      {
        title: 'Titanic\'s passengers',
        type: 'Multi categorical',
        url: '../assets/data/titanic.tsv'
      },
      {
        title: 'Most frequent letters',
        type: 'Matrix (narrow)',
        url: '../assets/data/letters.tsv'
      }
    ]
