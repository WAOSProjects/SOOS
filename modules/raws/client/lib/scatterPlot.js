(function() {
  ...
  var chart = raw.chart()
        ...
        .thumbnail('./modules/raws/client/img/scatterPlot.png')
  ...
  chart.draw(function(selection, data) {
    ...
    var marginLeft = d3.max([maxRadius(), (d3.max(data, function(d) {
    ...
    var xScale = x.type() == 'Date' ?
      ...
      sizeScale = d3.scale.linear().range([1, Math.pow(+maxRadius(), 2) * Math.PI]).domain([0, d3.max(data, function(d) {
        return d.size;
      })]),
